...
interface Message {
  ...
  text: string;
  displayName: string;
  timestamp: number | { seconds?: number }; // handles both numeric and Firestore-style timestamps
}
...
function ChatContent() {
  ...
  const formatTime = (timestamp: number | { seconds?: number }) => {
    const time =
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow py-12 bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            {...fadeInUp}
            transition={{ duration: 0.3, ease: [0.4, 0, 0.2, 1] }} // ✅ fixed easing type
          ...
          >
            <div className="p-6 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-blue-600 to-purple-600">
              <h1 className="text-2xl font-bold text-white">Class Chat</h1>
